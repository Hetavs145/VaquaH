  ...
  const contractTypes = [
    {
      ...
      downloadLink: '/contracts/standard-installation.pdf'
    },
    {
      id: 2,
      ...
      icon: <FileText size={40} className="text-vaquah-blue" />,
      downloadLink: '/contracts/annual-maintenance.pdf'
    },
    {
      id: 3,
      ...
      icon: <FileText size={40} className="text-vaquah-blue" />,
      downloadLink: '/contracts/extended-warranty.pdf'
    }
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {contractTypes.map((contract) => (
                ...
                >
                  ...
                  <Button className="bg-vaquah-blue hover:bg-vaquah-dark-blue w-full mb-3">
            ...
            <div className="space-y-4">
              ...
              <div className="border-b pb-4">
                ...
                <p className="text-gray-600">
                  ...
                  all major payment methods, including credit/debit cards and bank transfers.
                </p>
              </div>
            </div>
          </div>
