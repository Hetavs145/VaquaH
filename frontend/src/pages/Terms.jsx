...
import { ArrowLeft, FileText, Shield, CreditCard, Truck, Wrench, AlertTriangle, CheckCircle, Mail, Phone, Clock, MapPin } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-vaquah-blue text-white py-20 animate-fade-in">
        <div className="container-custom text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 animate-slide-up">Terms of Service</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 flex items-center">
              <Wrench className="w-6 h-6 mr-2 text-vaquah-blue" />
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 flex items-center">
              <CreditCard className="w-6 h-6 mr-2 text-vaquah-blue" />
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 flex items-center">
              <Truck className="w-6 h-6 mr-2 text-vaquah-blue" />
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 flex items-center">
              <CheckCircle className="w-6 h-6 mr-2 text-vaquah-blue" />
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              GOVERNING LAW
              These Terms shall be governed by and defined following the laws of India. VaquaH and yourself irrevocably consent that the courts of Vadodara shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.
            </p>
          </section>
