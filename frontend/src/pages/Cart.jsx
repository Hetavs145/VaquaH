          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="lg:col-span-2">
              {cartItems.map((item, index) => (
                <div key={item._id || `cart-item-${index}`} className="border rounded-lg p-3 sm:p-4 mb-4">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                    ...
                    <button 
                      ...
                      className="text-red-500 hover:text-red-700 text-sm sm:text-base self-start sm:self-center"
                    >
                      Remove
                    </button>
                  </div>
